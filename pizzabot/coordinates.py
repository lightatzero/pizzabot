...
class PizzabotCoordinate():
        ...
        for arg in argv:
            if isinstance(arg, int):
                self.points.append(arg)
                 ...
                 raise ValueError("ValueError exception thrown, non-int passed to PizzabotCoordinate", argv)
    ...
    def _check_len (self,other):
        if len(self) != len(other):
            raise TypeError("TypeError exception thrown, PizzabotCoordinate points dimensions do not match", self.points, other.point)
